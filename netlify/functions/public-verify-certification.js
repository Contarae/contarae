...
function buildPublicPayload(detail, matchedIssuedCertificate = null) {
  ...
  return {
    ...
    certificate: {
      ...
      periodType: certificateData.periodo_tipo || summary.periodType || "",
      periodYear: certificateData.periodo_vigencia || summary.periodYear || "",
      periodStartDate: certificateData.periodo_fecha_inicio || summary.periodStartDate || "",
      periodEndDate: certificateData.periodo_fecha_fin || summary.periodEndDate || "",
