...
function CrtS(){
  ...
  const buildPendingPayload=(paymentReference,uploadedSupportFiles=[])=>({
    ...
    total_ingresos_global_periodo:"$"+fm(globalPeriodTotal),
